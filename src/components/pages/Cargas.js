...
import styles from './Cargas.module.css'
import aos from 'aos'
...
function Cargas(){
    ...
    return(
        ...
        <div className={styles.box} data-aos="fade-right">
           ...
           <h2> Rastreador Cargas</h2> 
           <p>Tenha controle total de sua Cargas com rastreadores 
            Insat.</p>
        </div>
...
<div className={styles.content}>
    ...
    <h2 data-aos="fade-down">Rastreador para Cargas </h2>
<p>Rastreamento via satélite para Cargas, localização da seu Cargas via internet ou 
