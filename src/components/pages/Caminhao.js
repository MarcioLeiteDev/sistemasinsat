...
import styles from './Caminhao.module.css'
import aos from 'aos'
...
function Caminhao(){
    ...
    return(
        ...
        <div className={styles.box} data-aos="fade-right">
           ...
           <h2> Rastreador Caminhão</h2> 
           <p>Tenha controle total de seu caminhão com rastreadores para 
            Caminhão Insat.</p>
        </div>
...
<div className={styles.content}>
    ...
    <h2 data-aos="fade-down">Rastreador para Caminhão </h2>
<p>Rastreamento via satélite para Caminhão, localização da seu caminhão via internet ou 
