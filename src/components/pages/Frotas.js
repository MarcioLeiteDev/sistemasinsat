...
function Caminhao(){
    ...
    return(
        ...
        <div className={styles.box} data-aos="fade-right">
           ...
           <h2> Rastreador Frotas</h2> 
           <p>Tenha controle total de seu Frotas com rastreadores para 
            Frotas Insat.</p>
        </div>
...
<div className={styles.content}>
    ...
    <h2 data-aos="fade-down">Rastreador para Frotas </h2>
<p>Rastreamento via satélite para Frotas, localização da seu Frotas via internet ou 
