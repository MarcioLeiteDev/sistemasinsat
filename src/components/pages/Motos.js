...
function Motos(){
    ...
    return(
        ...
        <div className={styles.box} data-aos="fade-right">
           ...
           <h2> Rastreador Motos</h2> 
           <p>Tenha controle total de sua motocicleta com rastreadores para 
            motos Insat.</p>
        </div>
...
<div className={styles.content}>
    ...
    <h2 data-aos="fade-down">Rastreador para Motos </h2>
<p>Rastreamento via satélite para motos, localização da sua moto via internet ou 
