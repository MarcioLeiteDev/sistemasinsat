...
function Carros(){
    ...
    return(
        ...
        <div className={styles.box} data-aos="fade-right">
           ...
           <p>Tenha controle total de seus veículos com rastreadores para 
            carros e utilitários Insat.</p>
        </div>
...
<div className={styles.content}>
    ...
    <h2 data-aos="fade-down">Rastreador para Carros </h2>
<p>Rastreamento via satélite para veículos, localização do veículo via internet ou 
